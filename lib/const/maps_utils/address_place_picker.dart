...
import '../maps_utils/google_map_place_picker.dart';
import '../maps_utils/providers/place_provider.dart';
import '../maps_utils/utils/uuid.dart';
import 'package:flutter/material.dart';
import 'package:geolocator/geolocator.dart';
import 'package:google_api_headers/google_api_headers.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import '../maps_utils/google_maps_place_picker.dart';
...
class AutoAddressPlacePicker extends StatefulWidget {
  const AutoAddressPlacePicker({
    Key? key,
  ...
  final Function(Geometry) onPicked;
  ...
  @override
  _AutoAddressPlacePickerState createState() => _AutoAddressPlacePickerState();
}

// SearchBarController searchBarController = SearchBarController();

class _AutoAddressPlacePickerState extends State<AutoAddressPlacePicker> {
  ...
  Widget _buildSearchBar(BuildContext context) {
    return AutoAdressCompleteSearch(
        appBarKey: appBarKey,
  ...
  _pickPrediction(Prediction prediction) async {
    ...
    widget.onPicked(provider!.selectedPlace!.geometry!);
