...
import '../maps_utils/place_picker.dart';
import '../maps_utils/providers/place_provider.dart';
import '../maps_utils/providers/search_provider.dart';
...
class AutoAdressCompleteSearch extends StatefulWidget {
  const AutoAdressCompleteSearch(
      {Key? key,
  ...
  @override
  AutoAdressCompleteSearchState createState() =>
      AutoAdressCompleteSearchState();
}

String address = '';
TextEditingController controller = TextEditingController();

class AutoAdressCompleteSearchState extends State<AutoAdressCompleteSearch> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      value: provider, child: _buildSearchTextField(),
    );
  }
          ...
          .map(
            (p) => PredictionTile(
              ...
              onTap: (selectedPrediction) {
                resetSearchBar();
                controller.text = selectedPrediction.description ?? '';
