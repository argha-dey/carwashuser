...
class OrderStatusApi {
  Future<dynamic> onorderstatusApi(String lang, String orderid) async {
    try {
      final uri = Uri.parse(Config.apiurl + 'staff-order-status');
...
final orderStatusApi = OrderStatusApi();
