...
class VehiclelbrandlistbycategoryApi {
  Future<dynamic> onvehiclebrandlistbycategoryApi(String lang, String catid) async {
    try {



      final uri = Uri.parse(Config.apiurl + 'brand?category_id='+catid);

    //  https://carwash.developerconsole.xyz/api/user-vehicle?category_id=1
 ...
 /*     final uri = Uri.parse(Config.apiurl + Config.vehiclelistbycategory);
      ...
      if (response.statusCode == 200) {
        ...
        return VehiclelbrandlistbycategoryModel.fromJson(responseJson);
...
final vehiclelistbycategoryApi = VehiclelbrandlistbycategoryApi();
