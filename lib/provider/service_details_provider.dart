...
class ServicedetailsApi {
  Future<dynamic> onservicedetailsApi(String lang, String id) async {
    try {
      final uri = Uri.parse(Config.apiurl + Config.servicedetails);
      dynamic postData = {
...
final servicedetailsApi = ServicedetailsApi();
