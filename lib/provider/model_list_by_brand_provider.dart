...
class VehiclelModellistbyBrandApi {
  Future<dynamic> onvehicleModellistbyBrandApi(String lang, String catogaryId,String brandId) async {
    try {

      final uri = Uri.parse(Config.apiurl + 'car-model?category_id='+brandId+"&brand_id="+catogaryId);
 ...
 /*     final uri = Uri.parse(Config.apiurl + Config.vehiclelistbycategory);
      ...
      if (response.statusCode == 200) {
        ...
        return VehiclelmodellistbybrandModel.fromJson(responseJson);
...
final vehiclemodellistbybrandApi = VehiclelModellistbyBrandApi();
