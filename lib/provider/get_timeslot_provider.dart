...
class GettimeslotApi {
  Future<dynamic> ongettimeslotApi(String _weekDay,date) async {
    try {

      final uri = Uri.parse(Config.apiurl + "timeslot?day="+_weekDay);
    ...
    'Accept-Language': '${PrefObj.preferences!.get(PrefKeys.LANG)}',
      ...
      if (response.statusCode == 200) {
        ...
        return GettimeslotModel.fromJson(responseJson);
...
final gettimeslotApi = GettimeslotApi();
